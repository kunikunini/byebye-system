  ...
  return (
    <div className="relative space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 max-w-md">
        ...
        <button
          disabled={isLoading}
          className="flex w-full items-center justify-center gap-2 rounded-xl bg-black px-8 py-4 text-lg font-bold text-white shadow-xl shadow-black/20 transition-all duration-200 hover:scale-105 hover:bg-gold-2 hover:text-black hover:shadow-2xl active:scale-95 disabled:scale-100 disabled:opacity-50"
          type="submit"
        >
          {isLoading ? (
            <>
